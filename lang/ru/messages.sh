...
MSG_CLIPBOARD_STRING_HEADER="\nВ целом у вас должна быть так называемая clipboard string, выглядит примерно так: $MSG_VMESS_EXAMPLE"
...
MSG_XUI_ENTER_ADMIN_PASSWORD_1="Укажите пароль пользователя admin для"
MSG_XUI_ENTER_ADMIN_PASSWORD_2="(по умолчанию случайный): "
...
MSG_CONTAINER_EXISTS_PART1="Не удается создать контейнер, проверьте контейнеры: docker ps -a"
...
MSG_ADMIN_USERNAME="Имя пользователя: "
...
MSG_OPENVPN_INSTALLER_HEADER="Установщик $MSG_NAME_OPENVPN. Выберите действие:"
MSG_OPENVPN_AUTO_INSTALL="1. Автоматическая установка $MSG_NAME_OPENVPN"
MSG_OPENVPN_MANUAL_MENU="2. Меню управления $MSG_NAME_OPENVPN и ручная установка"

# function avtoInstall_openVPN
MSG_OPENVPN_OPENVPN_INSTALL_SUCCESS="$MSG_NAME_OPENVPN успешно установлен!"
...
MSG_OPENVPN_WINDOWS_INSTRUCTIONS="1. Скачайте установщик $MSG_NAME_OPENVPN для Windows с официального сайта $MSG_NAME_OPENVPN.\n\
2. Установите программу, используя стандартный процесс установки.\n\
3. Запустите $MSG_NAME_OPENVPN.\n\
...
MSG_OPENVPN_ANDROID_INSTRUCTIONS="1. Скачайте и установите приложение $MSG_NAME_OPENVPN для Android из Google Play Store.\n\
2. Перенесите конфигурационный файл (с расширением .ovpn) на ваше Android-устройство.\n\
3. В приложении $MSG_NAME_OPENVPN нажмите иконку '+' для добавления нового профиля.\n\
...
MSG_OPENVPN_MACOS_INSTRUCTIONS="1. Установите Tunnelblick, бесплатный клиент $MSG_NAME_OPENVPN для macOS, скачав его с официального сайта.\n\
...
MSG_OPENVPN_LINUX_INSTRUCTIONS="1. Установите пакет $MSG_NAME_OPENVPN с помощью менеджера пакетов вашей дистрибуции (например, apt для Ubuntu или yum для CentOS).\n\
...
MSG_OPENVPN_IOS_INSTRUCTIONS="1. Установите приложение $MSG_NAME_OPENVPN Connect из App Store на ваше устройство iOS.\n\
2. Перенесите конфигурационный файл (с расширением .ovpn) на ваше устройство с помощью iTunes или других доступных методов.\n\
3. В приложении $MSG_NAME_OPENVPN Connect перейдите в 'Настройки' и выберите 'Импортировать $MSG_NAME_OPENVPN файл'.\n\
...
MSG_INSTALLATION_ERROR="Произошла ошибка при установке $MSG_NAME_OPENVPN. Пожалуйста, проверьте ваши настройки и попробуйте снова."
...
MSG_DEPENDENCY_NOT_INSTALLED=" не установлен."
MSG_DEPENDENCY_INSTALLED=" установлен."
MSG_ERROR_INFO_UNSUPPORTED_OS="Неподдерживаемая операционная система: "
MSG_ERROR_OS_DETECTION_FAILED="Не удалось определить операционную систему."
MSG_MISSING_PACKAGES="Отсутствующие пакеты:"
MSG_INSTALL_PROMPT="Установить отсутствующие пакеты? (y/n): "
MSG_INSTALLATION_CANCELLED="Установка отсутствующих пакетов отменена."
MSG_ALL_PACKAGES_INSTALLED="Все необходимые пакеты уже установлены."
MSG_ALL_PACKAGES_SUCCESSFULLY_INSTALLED="Все отсутствующие пакеты успешно установлены."
MSG_UNSUPPORTED_INSTALL_METHOD="Неподдерживаемый метод установки."
...
MSG_PORT="Порт "
MSG_PORT_OPEN="открыт в iptables."
...
MSG_RULE_DELETED_PART1="Правило с портом"
MSG_RULE_DELETED_PART2="и ID "
MSG_RULE_DELETED_PART3="успешно удалено."
MSG_RULE_DELETE_FAILED_PART1="Не удалось удалить правило с ID"
MSG_RULE_DELETE_FAILED_PART2="."
MSG_RULE_NOT_FOUND_PART1="Правило с портом "
MSG_RULE_NOT_FOUND_PART2="не найдено."
...
MSG_ERROR_CONTAINER_NAME="Ошибка: имя контейнера не может быть пустым."

# function update_xui_settings
MSG_USERNAME_PASSWORD_UPDATED_PART1="Имя пользователя и пароль"
MSG_USERNAME_PASSWORD_UPDATED_PART2=" успешно обновлены."
MSG_USERNAME_PASSWORD_FAILED_PART1="Не удалось обновить имя пользователя и пароль."
MSG_PORT_UPDATED_PART1="Порт"
MSG_PORT_UPDATED_PART2=" успешно обновлён."
MSG_PORT_FAILED_PART1="Не удалось обновить порт."
MSG_WEB_BASE_PATH_UPDATED_PART1="Базовый путь"
MSG_WEB_BASE_PATH_UPDATED_PART2=" успешно обновлён."
MSG_WEB_BASE_PATH_FAILED_PART1="Не удалось обновить базовый путь."
